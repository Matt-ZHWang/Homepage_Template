...
pages/3.html (local visual reference, not part of the published site)
...
Hero visual direction: keep the original 3.html stage/ruin style using source materials such as `vid.mp4`, `judge_house.png`, `ruin.png`, `wide.png`, and `talkwoman_drag.png`. Do not crowd the first screen with unrelated JWST/LRD collage images.

Project covers:

- `source materials/bias_cover.png`
- `source materials/BHE_cover.png`
